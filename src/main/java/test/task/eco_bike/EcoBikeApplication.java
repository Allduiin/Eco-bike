...
public class EcoBikeApplication {
    public static void main(String[] args) throws IOException {
        ...
        run.getBean(ReadFromFileService.class).read("D:\\Java\\ecobike\\src\\main\\resources\\TestFile.txt");
        System.out.println(run.getBean(FoldingBikeService.class).getAll());
    }
}
